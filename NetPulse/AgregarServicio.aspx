<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AgregarServicio.aspx.cs" Inherits="NetPulse.AgregarServicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="btnBaja" Style="margin: 20px" type="submit" CssClass="btn btn-danger" runat="server" Text="Eliminar Servicio" OnClick="btnBaja_Click" />
